...
2. Open the program, then open the image file of the 3rd page of the issue you scanned (pages 1 and 2 have lots of ads in them, and are a more complicated place to start). When you open the document, Finereader will automatically read it. Let it do its work.
